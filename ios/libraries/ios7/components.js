...
prx.types.ios7_checkbox = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '<label for="'+_id+'-checkbox" class="ios7-checkbox-inner '+((item.active) ? 'liveUpdate-activeBackgroundColor' : 'liveUpdate-backgroundColor liveUpdate-borderColor') + ' changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius">';
...
prx.types.ios7_switch = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '<label for="'+_id+'-flipswitch" class="'+((item.active) ? 'liveUpdate-activeBorderColor liveUpdate-activeLabelColor' : 'liveUpdate-inactiveBorderColor liveUpdate-inactiveLabelColor')+'">';
